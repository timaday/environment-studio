...
| Engineering | Old specs hard-coded domain concepts | Closed generic definitions and application-owned adapters |
...
review should challenge each assumption with actual application examples.
