...
digests are [implemented and reviewed](../evidence/qf34-history-v3.md); storage and
HTTP remain pending. Existing
...
V3 storage and HTTP are separate follow-on implementation work. They must preserve
