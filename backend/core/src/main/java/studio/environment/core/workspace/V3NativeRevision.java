...
/** Separate immutable v3 historical data; no current publication eligibility is represented. */
public record V3NativeRevision(String objectId, String workspaceRevision, DraftCommand.Format format, String source,
        String sourceDigest, String compilerVersion, String schemaVersion, Content content, Optional<Publication> publication) {
    public V3NativeRevision {
    ...
    public record Definition(NativeCompilationResult.Checked checked, List<DefinitionDiagnostic> diagnostics) implements Content {
        ...
        public boolean historicalReady() { return diagnostics.isEmpty(); }
    ...
    @Override public String toString() { return "V3NativeRevision[redacted]"; }
}
