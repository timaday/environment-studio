...
public final class V3PhysicalHttpWitnesses {
    private V3PhysicalHttpWitnesses() {}
    public static NativeCompilationResult.Checked definition() {
        ...
        var mapped=new Projection(projection.id(),projection.type(),projection.path(),mappings,projection.references());
    ...
    public static final String XML="<items><!-- mock -->\r\n<item id='one' tone='al&#112;ha' finish='x' secret='MOCK-SECRET-VIEW' optional=''/><item id='two' tone='alpha' finish='y'/><item id='three' tone='beta' finish='x'/></items>";
