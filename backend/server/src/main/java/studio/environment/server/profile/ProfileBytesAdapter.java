...
public final class ProfileBytesAdapter {
    ...
    private final PortableProfileCodec codec = new PortableProfileCodec(ProfileWireEncoding.Version.V2);
    ...
    public Result capture(ReadyToPublish definition, ProjectionResult.Accepted observation, ProfileCapture.Command command) {
        ...
        return accepted(codec.portable(new ProfileCapture().capture(definition, new GraphValidationResult.Accepted(observation.graph()), command),
