...
class IndependentPrivacyNativeLaunchTest {
    ...
    @BeforeAll static void compile() throws Exception {
        ...
        assertEquals(0,PrivacyConnectionTest.run(List.of("/usr/bin/cc","-std=c17","-O2","-Wall","-Wextra","-Werror","-pthread","-fstack-protector-strong","-D_FORTIFY_SOURCE=3","-fPIE","-pie","-Wl,-z,relro,-z,now","-Wl,--wrap=eventfd,--wrap=getrandom,--wrap=close,--wrap=es_listener_close","-Isrc/main/c","src/main/c/privacy-peer.c","src/main/c/privacy-fork.c","src/main/c/privacy-listener.c","src/main/c/privacy-wire.c","src/main/c/privacy-connection.c","src/main/c/privacy-root.c","src/main/c/privacy-launch.c","src/main/c/privacy-maps.c","src/main/c/privacy-file.c","src/main/c/privacy-hash.c","src/main/c/privacy-image.c","src/main/c/privacy-elf.c","src/test/c/independent-privacy-launch-probe.c","-lcrypto","-o",probe.toString())));
    }
