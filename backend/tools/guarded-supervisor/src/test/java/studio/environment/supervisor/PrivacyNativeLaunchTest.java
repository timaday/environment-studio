...
class PrivacyNativeLaunchTest {
    ...
    static void compileJni() throws Exception {
        ...
        for(String name:List.of("controls","peer","fork","listener","wire","connection","root","launch"))command.add("src/main/c/privacy-"+name+".c");
