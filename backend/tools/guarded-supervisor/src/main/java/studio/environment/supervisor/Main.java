...
public final class Main {
    ...
    public static void main(String[] args) {
        Supervisor.Result result=execute(()->RuntimePrivacy.established()?new Supervisor().apply(args,RuntimeComposition.REGISTRY,RuntimeComposition.console(args),RuntimeComposition.runtime()):new Supervisor.Result("REFUSED","RUNTIME_PRIVACY_UNQUALIFIED",SessionEngine.Cleanup.COMPLETE));
